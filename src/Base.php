...
class Base {
	 ...
	 * @var   string
	 */
	protected string $db_global = 'wpdb';
	 ...
	 *
	 */
	protected function apply_prefix( string $string = '', string $sep = '_' ) {
	 ...
	 *
	 */
	protected function first_letters( string $string = '', string $sep = '_' ): string {
	 ...
	 *
	 */
	protected function sanitize_table_name( string $name = '' ) {
	 ...
	 * @since 1.0.0
	 */
	protected function set_vars( array $args = array() ) {
